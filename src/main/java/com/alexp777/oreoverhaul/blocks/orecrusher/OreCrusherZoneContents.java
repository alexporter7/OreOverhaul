...
public class OreCrusherZoneContents implements IInventory {
     ...
     */
    public static OreCrusherZoneContents createForTileEntity(int size,
                                                          Predicate<PlayerEntity> canPlayerAccessInventoryLambda,
                                                          Notify markDirtyNotificationLambda) {
        return new OreCrusherZoneContents(size, canPlayerAccessInventoryLambda, markDirtyNotificationLambda);
    }

    /**
     * Use this constructor to create a OreCrusherZoneContents which is not linked to any parent TileEntity; i.e.
     ...
     * @return the new ChestContents
     */
    public static OreCrusherZoneContents createForClientSideContainer(int size) {
        return new OreCrusherZoneContents(size);
    }
    ...
    private OreCrusherZoneContents(int size) {
        this.furnaceComponentContents = new ItemStackHandler(size);
    }

    private OreCrusherZoneContents(int size, Predicate<PlayerEntity> canPlayerAccessInventoryLambda, Notify markDirtyNotificationLambda) {
        this.furnaceComponentContents = new ItemStackHandler(size);
        this.canPlayerAccessInventoryLambda = canPlayerAccessInventoryLambda;
        this.markDirtyNotificationLambda = markDirtyNotificationLambda;
    }
