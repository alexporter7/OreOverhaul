package com.alexp777.oreoverhaul.util;
...
public class HighHeatFurnaceItemHandler extends ItemStackHandler {

    public HighHeatFurnaceItemHandler(int size, ItemStack... stacks) {
        super(size);
